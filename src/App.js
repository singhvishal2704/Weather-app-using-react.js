...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(position => {
        ...
        //Weather Api call
        Axios.get(`http://api.weatherstack.com/current?access_key=ad751a1c9985071e1a5d047ee53e29bf&query=${this.state.userPosition.latitude},${this.state.userPosition.longitude}`).then(res => {
  ...
  changeLocation = (e) => {
    ...
    Axios.get(`http://api.weatherstack.com/current?access_key=ad751a1c9985071e1a5d047ee53e29bf&query=${this.state.regionInput}`).then(res => {
